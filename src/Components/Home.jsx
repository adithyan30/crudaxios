    ...
    <div className="container my-5">
      <div className="row align-items-center">
        <div className="col-lg-7 text-center text-lg-start">
          ...
          <img
            src="https://cdni.iconscout.com/illustration/premium/thumb/customer-support-executive-helping-customer-2996661-2500693.png"
            className="img-fluid"
            alt="Contact Us Illustration"
          />
        </div>
        <div className="col-md-10 mx-auto col-lg-5">
            <h2 className="display-4 fw-bold lh-1 text-black mb-4">
